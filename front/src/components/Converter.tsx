...
let convertFromSource = async (source: string) => {
    ...
    if (source === "moxfield") {
        ...
        document.getElementById("loaderInButton")!.style.display = "none"
    }
    else {
        console.log("else")
    }
    ...
    return (
        <div>
            <div className="m-8 flex">
                ...
                />
                <button
                    className="ml-3 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-600 hover:border-b-0 rounded"
                    id="convert-btn"
                    onClick={() => convertFromSource(props.type)}
                >
                    <div className="flex">
                        <div id="loaderInButton" style={{display: "none"}}>
